...
async function saveChanges(userId) {
    ...
    try {
        const response = await fetch(`https://ehs-deploy-sooty.vercel.app/api/update-users/${userId}`, {
            method: 'PUT',
            headers: {
...
async function changePassword(userId) {
    ...
    try {
        const response = await fetch('https://ehs-deploy-sooty.vercel.app/api/change-password', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
