document.addEventListener('DOMContentLoaded', async function () {
    ...
    try {
        ...
        const response = await fetch('https://ehs-deploy-sooty.vercel.app/api/dashboard/total');
        ...
        if (response.ok) {
            ...
            const topServicesResponse = await fetch('https://ehs-deploy-sooty.vercel.app/api/services/top-booked');
            ...
            if (topServicesResponse.ok) {
                ...
                if (topServicesData.length === 0) {
                    ...
                    topServicesData.forEach(service => {
                        ...
                        listItem.innerHTML = `
                            <img src="https://ehs-deploy-sooty.vercel.app/${service.image}" alt="${service.name}">
